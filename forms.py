...
from wtforms.validators import DataRequired, AnyOf, URL,Regexp,re,length
...
class ArtistForm(Form):
    ...
    phone = StringField(
        ...
        'phone', validators=[DataRequired(),length(min=6, max=35)])
    ...
    genres = SelectMultipleField(
     ...
     # 'facebook_link',validators=[ URL(), DataRequired(), Regexp( '“((http|https)://)(www.)?” + “[a-zA-Z0-9@:%._\\+~#?&//=]{2,256}\\.[a-z]” + “{2,6}\\b([-a-zA-Z0-9@:%._\\+~#?&//=]*)”')]
